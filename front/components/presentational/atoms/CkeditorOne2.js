...
class CkeditorOne2 extends Component{
    constructor(props){
        super(props);
        this.state={
                        ...
                        { name: 'insert',
                         items: ['Table','Mathjax','Smiley','SpecialChar'] 
                             ...
                             name: 'colors',
                              ...
                              extraPlugins:'mentions, codesnippet, sourcedialog,justify,embed,autoembed,image2,autogrow,font,colorbutton,colordialog,tableresize,mathjax',
                              uiColor:'#c6badf',
                              height:'200px',
                              width:'99.7%',
